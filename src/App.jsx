      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto px-6 py-12">
        ...
        <section className="py-16 border-t border-black/5 dark:border-white/10 overflow-hidden text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-black/[0.02] dark:bg-white/5 p-6 md:p-8 rounded-[2rem] border border-black/[0.05] dark:border-white/10 flex flex-col h-[400px]"><h3 className="text-lg font-bold mb-10 opacity-80">{t.graph1Title}</h3><div className="flex-1 flex items-end justify-around gap-4 relative px-4 border-b border-black/10 dark:border-white/10 pb-8"><div className="flex-1 flex flex-col items-center gap-6 h-full justify-end relative"><div className="w-full flex justify-center items-end gap-1.5 h-full"><motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 1.5, ease: "circOut" }} style={{ originY: 1 }} className="w-8 md:w-10 bg-red-500 rounded-t-xl h-[70%]" /><motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 1.5, ease: "circOut", delay: 0.2 }} style={{ originY: 1 }} className="w-8 md:w-10 bg-[var(--accent-color)]/30 rounded-t-xl h-[20%]" /></div><div className="absolute -bottom-8 w-full"><span className="text-[9px] font-black uppercase tracking-widest opacity-40 block">{t.graph1Before}</span></div></div><div className="flex-1 flex flex-col items-center gap-6 h-full justify-end relative"><div className="w-full flex justify-center items-end gap-1.5 h-full"><motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 1.5, ease: "circOut", delay: 0.4 }} style={{ originY: 1 }} className="w-8 md:w-10 bg-red-500/20 rounded-t-xl h-[15%]" /><motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 1.5, ease: "circOut", delay: 0.6 }} style={{ originY: 1 }} className="w-8 md:w-10 bg-[var(--accent-color)] rounded-t-xl h-[95%] shadow-[0_0_40px_var(--accent-color)]" /></div><div className="absolute -bottom-8 w-full"><span className="text-[9px] font-black uppercase tracking-widest block">{t.graph1After}</span></div></div></div><div className="mt-12 flex justify-center gap-6 text-[9px] font-bold uppercase tracking-widest opacity-50"><span className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-red-500" />{t.graph1Failures}</span><span className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-[var(--accent-color)]" />{t.graph1Successes}</span></div></motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-black/[0.02] dark:bg-white/5 p-6 md:p-8 rounded-[2rem] border border-black/[0.05] dark:border-white/10 flex flex-col h-[400px] relative overflow-hidden text-center"><h3 className="text-lg font-bold mb-2 opacity-80">{t.graph2Title}</h3><p className="text-xs opacity-40 mb-10">{t.graph2Desc}</p><div className="flex-1 relative mt-10 border-b border-black/10 dark:border-white/10 mb-8"><svg viewBox="0 0 200 100" className="w-full h-full overflow-visible" preserveAspectRatio="none"><defs><linearGradient id="chartGradientMain" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="var(--accent-color)" stopOpacity="0.4" /><stop offset="100%" stopColor="var(--accent-color)" stopOpacity="0" /></linearGradient></defs><motion.path d="M0,95 C40,90 60,70 100,50 S160,10 200,5" fill="none" stroke="var(--accent-color)" strokeWidth="6" strokeLinecap="round" initial={{ pathLength: 0 }} whileInView={{ pathLength: 1 }} transition={{ duration: 2.5, ease: "easeInOut" }} /><motion.path d="M0,95 C40,90 60,70 100,50 S160,10 200,5 L200,100 L0,100 Z" fill="url(#chartGradientMain)" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1.5, delay: 1 }} /></svg></div><div className="flex justify-between text-[9px] font-black uppercase tracking-[0.3em] opacity-30 mt-2"><span>Day 1</span><span>Day 100</span></div></motion.div>
          </div>
        </section>
        <section className="py-16 border-t border-black/5 dark:border-white/10"><motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center max-w-lg mx-auto mb-12"><h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">{t.promoTitle}</h2><p className="text-lg text-black/40 dark:text-white/50 leading-relaxed italic">"{t.promoIntro}"</p></motion.div><div className="grid gap-6">{[{ icon: '🧠', title: t.promo1Title, desc: t.promo1Desc }, { icon: '⚡️', title: t.promo2Title, desc: t.promo2Desc }, { icon: '📈', title: t.promo3Title, desc: t.promo3Desc }, { icon: '⛽️', title: t.promo4Title, desc: t.promo4Desc }].map((item, i) => (<motion.div key={i} initial={{ opacity: 0, x: i % 2 === 0 ? -30 : 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-black/[0.03] dark:bg-white/5 border border-black/[0.05] dark:border-white/10 p-6 md:p-8 rounded-[2rem] flex flex-col md:flex-row gap-6 items-start transition-colors text-left"><span className="text-4xl shrink-0">{item.icon}</span><div><h3 className="text-xl font-bold mb-2">{item.title}</h3><p className="text-black/50 dark:text-white/50 text-[17px] leading-relaxed">{item.desc}</p></div></motion.div>))}</div></section>
